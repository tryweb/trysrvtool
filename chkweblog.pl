...
# Ver 1.00
#
# 取出 web log 內符合特定關鍵字串的存取 IP 與 時間
# Usage : chkweblog.pl <setting_file> <config_file>
#  * <setting_file> : default is chkweblog.set
#  * <config_file> : default is chkweblog.conf
#
# 1.00 (19:53 2014/10/16) First Version Release
#
$prgname = substr($0, rindex($0,"/")+1);
$ver = "1.00 (2014/10/16)";

$p_setting = !defined($ARGV[0])?"/opt/trysrvtool/chkweblog.set":$ARGV[0];
$p_config = !defined($ARGV[1])?"/opt/trysrvtool/chkweblog.conf":$ARGV[1];
